...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Премиум асфальтирование, благоустройство, разработка котлованов, аренда спецтехники и доставка материалов. Собственный парк, инженерный подход." },
      ...
      { name: "twitter:title", content: "ПРЕМИУМ СТРОЙ — Асфальтирование и благоустройство" },
      { name: "twitter:description", content: "Премиум асфальтирование, благоустройство, разработка котлованов, аренда спецтехники и доставка материалов. Собственный парк, инженерный подход." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5dc05e4a-3693-4ba5-85d4-f8d0e70f4d3d/id-preview-daec86a2--68ffee32-5bae-4280-8dd5-535897e8a458.lovable.app-1778561227674.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/5dc05e4a-3693-4ba5-85d4-f8d0e70f4d3d/id-preview-daec86a2--68ffee32-5bae-4280-8dd5-535897e8a458.lovable.app-1778561227674.png" },
    ],
    links: [
